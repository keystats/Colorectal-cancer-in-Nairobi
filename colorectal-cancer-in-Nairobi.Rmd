---
title: "Colorectal Cancer in Nairobi"
author: "Jackson Kahungu Njeri"
date: "2025-05-09"
output:
  pdf_document:
    latex_engine: xelatex    # use Unicode-capable engine
    keep_tex: true           # retain .tex for debugging
geometry: margin=1in
highlight: tango
header-includes:
  - \usepackage{fontspec}      # load system font support
  - \setmainfont{TeX Gyre Termes}
  - \usepackage{graphicx}      # ensure graphic inclusion
knitr:
  opts_chunk:
    echo: FALSE
    warning: FALSE
...
library(knitr)
# Set root directory for figures
...
```{r}
knitr::include_graphics("images/my-figure.png")
```
